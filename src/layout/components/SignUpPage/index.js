...
function Index(props) {
    ...
    const { handle: checkDuplicateHandle, state: checkDuplicateState } = useAsync();
    ...
    const [recoveryConfirmationCode, setRecoveryConfirmationCode] = useState(null);
