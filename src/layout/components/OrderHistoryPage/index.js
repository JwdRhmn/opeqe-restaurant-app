...
function Index(props) {
    ...
    const orderConfirmationCode = selectedOrder.id && getConfirmationCode(selectedOrder.id);
    const cancelConfirmationCode = cacnelData.confirmation && getConfirmationCode(cacnelData.confirmation);
