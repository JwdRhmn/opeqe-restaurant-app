...
const ShoppingCartPage =importModule(
    () => import(/* webpackChunkName: "ShoppingCartPage" */'./components/ShoppingCartPage')
);
const ItemInstructionPage =importModule(
    () => import(/* webpackChunkName: "ItemInstructionPage" */'./components/ItemInstructionPage')
);
...
const OrderOptionsPage =importModule(
    () => import(/* webpackChunkName: "OrderOptionsPage" */'./components/OrderOptionsPage')
);
...
const ReservationListPage =importModule(
    () => import(/* webpackChunkName: "ReservationListPage" */'./components/ReservationListPage')
);
const ReservationOptionsPage =importModule(
    () => import(/* webpackChunkName: "ReservationOptionsPage" */'./components/ReservationOptionsPage')
);
...
const OrderHistoryPage =importModule(
    () => import(/* webpackChunkName: "OrderHistoryPage" */'./components/OrderHistoryPage')
);
const FilteredItemsPage =importModule(
    () => import(/* webpackChunkName: "FilteredItemsPage" */'./components/FilteredItemsPage')
);
